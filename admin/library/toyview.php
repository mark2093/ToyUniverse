    ...
    <table class="table table-hover">
        ...
        <tbody id="userData">
            <?php
                include 'DB.php';
                $db = new DB();
                $users = $db->getRows('lib_products',array('order_by'=>'Id DESC'));
            ...
            <tr class="info">
                ...
                <td><?php echo $user['Image1']; ?></td>
                <td><?php echo $user['Points']; ?></td>
                <td><?php echo $user['Category']; ?></td>
                <td><?php echo $user['Description']; ?></td>
                <td><?php echo $user['Product_keywords']; ?></td>
                <td><?php echo $user['Main']; ?></td>
            </tr>
            <?php } }else{ ?>
            <tr class="warning"><td colspan="9">No Product(s) found...</td></tr>
            <?php } ?>
        </tbody>
        <div class="col-md-4 text-center">
        <button  class="btn btn-primary" onclick="window.location='libmgt.php';" style="align:center;">Back
        </div>
    </table>

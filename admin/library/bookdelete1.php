  ...
  <div>
    <div id="image-7" style="height:auto;">
      ...
      <div class="container" style="width:700px;">
        <h1 align="center" style="font-family:Georgia, serif;font-size:40px;"><span class="label label-info"><u><b>Delete Book</b></u></span></h1>
        <br />
        <form action="bookdelete1.php" method="POST">
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="image1" value= "<?php echo $image; ?>" />
            </div>
            <div class="form-group">
              <h4><span class="label label-primary">Book Points</span></h4>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="prokey"  value="<?php echo $prokey; ?>" />
            </div>
            <div class="form-group">
              <h4><span class="label label-primary">Book Main</span></h4>
              <input type="text" class="form-control" name="main"  value="<?php echo $main; ?>" />
            </div>
            <button type="submit" class="btn btn-danger btn-lg" name="delete" onclick="return confirm('Are you sure?')">Delete</button>

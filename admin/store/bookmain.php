          ...
          <div id="user_table">
            <table class="table table-hover"  border="10px">
              ...
              while($row = mysqli_fetch_array($result))
              {
                ?>
                <tr>
                  <td class="active"><?php echo $row["B_code"]; ?></td>
                  <td class="active"><?php echo $row["B_name"]; ?></td>
                  <td><input type="button" name="view" value="view" id="<?php echo $row["B_id"]; ?>" class="btn btn-primary btn-md view_data" /></td>
                </tr>
                <?php
              }
              ?>

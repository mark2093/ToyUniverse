...
<body >
  ...
  if(isset($_POST['update'])){
    ...
    $desci = $_POST['desci'];
    $mcode = $_POST['mcode'];
    $query = "UPDATE store_toys SET St_code='$_POST[code]',St_name='$_POST[name]',St_image='$_POST[image]',St_image1='$_POST[image1]',St_price='$_POST[price]',St_category='$_POST[cat]',St_description='$_POST[desci]' WHERE St_code='$_POST[mcode]'";
    $result = mysqli_query($connect, $query);

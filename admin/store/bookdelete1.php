...
<?php
  ...
  $desci = $_POST['desci'];
  $mcode = $_POST['mcode'];
  $query = "DELETE from store_books WHERE B_code='$_POST[mcode]'";
  $result = mysqli_query($connect, $query);
  ...
  <div>
    <div id="image-6" style="height:700px;">
      ...
      <div class="container" style="width:700px;">
        <h1 align="center" style="font-family:Georgia, serif;font-size:40px;"><span class="label label-danger"><u><b>Delete Book</b></u></span></h1>
        <br />

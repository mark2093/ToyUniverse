...
<div class="modal-header">
    ...
    <h1 class="text-center" style="font-family: Impact;">Add User</h1>
</div>
<div class="modal-body">
  <form role="form" action="header.php" method="post" >
    <form class="form col-md-12 center-block">
	<div class="form-group">
        <input type="text" class="form-control input-lg" placeholder="Fname" name="fname">
      </div>
      
	  <div class="form-group">
        <input type="text" class="form-control input-lg" placeholder="Lname" name="lname">
      </div>
	...
	<div class="form-group">
	  ...
	  <div>
	  <input type="password" class="form-control input-lg" placeholder="Re-Password" name="repass">
	  </div>
